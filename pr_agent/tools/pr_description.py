...
from pr_agent.algo.utils import ModelType, get_user_labels, load_yaml, set_custom_labels
    ...
    async def run(self):
        try:
            ...
            await retry_with_fallback_models(
                self._prepare_prediction, ModelType.TURBO
            )  # turbo model because larger context
